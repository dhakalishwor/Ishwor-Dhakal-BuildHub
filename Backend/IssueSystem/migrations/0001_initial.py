# Generated by Django 5.2.8 on 2026-02-24 11:53
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('report_type', models.CharField(choices=[('USER', 'User'), ('PROJECT', 'Project'), ('CHAT', 'Chat Message'), ('PAYMENT', 'Payment'), ('OTHER', 'Other')], max_length=20)),
