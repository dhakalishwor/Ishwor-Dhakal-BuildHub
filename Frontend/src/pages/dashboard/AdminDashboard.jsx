...
export default function App() {
  ...
  // Fetch contractors from backend on mount
  useEffect(() => {
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">Contractor Management</p>
            </div>
          </div>
        </div>
      </header>
          ...
          <div className="p-4">
            ...
            >
              <div className="flex items-center justify-between">
                <span className="font-semibold">Add Contractor</span>
                <span className="text-xs rounded-full bg-white/15 px-2 py-1">Admin</span>
              </div>
              <p className="mt-1 text-xs text-emerald-200">
                Add or update contractor profile
              </p>
            </button>
          </div>
        </aside>
                      ...
                      <table className="min-w-full text-sm">
                        <thead className="bg-emerald-50">
                          <tr className="text-left text-emerald-900">
                            ...
                            <th className="px-5 py-3 font-semibold">Exp</th>
                          ...
                          {filtered.length === 0 ? (
                            ...
                            filtered.map((c) => (
                              <tr key={c.id} className="border-t">
                                <td className="px-5 py-3 font-semibold">{c.fullName}</td>
                                <td className="px-5 py-3">{c.contractorType}</td>
                                <td className="px-5 py-3">{c.workType}</td>
                                <td className="px-5 py-3">{c.experienceYears} yrs</td>
                                <td className="px-5 py-3">{c.phone}</td>
                                <td className="px-5 py-3">{c.email || "-"}</td>
                                <td className="px-5 py-3">{c.availabilityStatus}</td>
                                <td className="px-5 py-3">{c.rateType}</td>
